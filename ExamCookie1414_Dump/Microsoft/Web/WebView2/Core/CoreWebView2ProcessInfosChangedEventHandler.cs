...
// Type: Microsoft.Web.WebView2.Core.CoreWebView2ProcessInfosChangedEventHandler
...
{
  internal class CoreWebView2ProcessInfosChangedEventHandler : 
    ICoreWebView2ProcessInfosChangedEventHandler
  {
    private CoreWebView2ProcessInfosChangedEventHandler.CallbackType _callback;

    public CoreWebView2ProcessInfosChangedEventHandler(
      CoreWebView2ProcessInfosChangedEventHandler.CallbackType callback)
    {
