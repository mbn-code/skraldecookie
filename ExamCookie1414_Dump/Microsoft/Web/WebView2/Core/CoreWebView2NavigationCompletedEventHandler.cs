...
// Type: Microsoft.Web.WebView2.Core.CoreWebView2NavigationCompletedEventHandler
...
{
  internal class CoreWebView2NavigationCompletedEventHandler : 
    ICoreWebView2NavigationCompletedEventHandler
  {
    private CoreWebView2NavigationCompletedEventHandler.CallbackType _callback;

    public CoreWebView2NavigationCompletedEventHandler(
      CoreWebView2NavigationCompletedEventHandler.CallbackType callback)
    {
