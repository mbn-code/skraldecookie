...
// Type: Microsoft.Web.WebView2.Core.CoreWebView2CustomItemSelectedEventHandler
...
{
  internal class CoreWebView2CustomItemSelectedEventHandler : 
    ICoreWebView2CustomItemSelectedEventHandler
  {
    private CoreWebView2CustomItemSelectedEventHandler.CallbackType _callback;

    public CoreWebView2CustomItemSelectedEventHandler(
      CoreWebView2CustomItemSelectedEventHandler.CallbackType callback)
    {
