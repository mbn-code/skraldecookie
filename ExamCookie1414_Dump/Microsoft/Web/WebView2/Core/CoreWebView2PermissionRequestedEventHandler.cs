...
// Type: Microsoft.Web.WebView2.Core.CoreWebView2PermissionRequestedEventHandler
...
{
  internal class CoreWebView2PermissionRequestedEventHandler : 
    ICoreWebView2PermissionRequestedEventHandler
  {
    private CoreWebView2PermissionRequestedEventHandler.CallbackType _callback;

    public CoreWebView2PermissionRequestedEventHandler(
      CoreWebView2PermissionRequestedEventHandler.CallbackType callback)
    {
