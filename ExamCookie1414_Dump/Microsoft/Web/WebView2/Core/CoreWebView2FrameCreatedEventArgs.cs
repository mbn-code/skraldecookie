...
// Type: Microsoft.Web.WebView2.Core.CoreWebView2FrameCreatedEventArgs
...
namespace Microsoft.Web.WebView2.Core
{
  ...
  public class CoreWebView2FrameCreatedEventArgs : EventArgs
  {
    ...
    internal ICoreWebView2FrameCreatedEventArgs _nativeICoreWebView2FrameCreatedEventArgs
    {
      ...
      set => this._nativeICoreWebView2FrameCreatedEventArgsValue = value;
    }
    ...
    public CoreWebView2Frame Frame
    {
      get
      {
        try
        {
          return this._nativeICoreWebView2FrameCreatedEventArgs.Frame == null ? (CoreWebView2Frame) null : new CoreWebView2Frame((object) this._nativeICoreWebView2FrameCreatedEventArgs.Frame);
        }
