...
// Type: Microsoft.Web.WebView2.Core.CoreWebView2WebMessageReceivedEventHandler
...
{
  internal class CoreWebView2WebMessageReceivedEventHandler : 
    ICoreWebView2WebMessageReceivedEventHandler
  {
    private CoreWebView2WebMessageReceivedEventHandler.CallbackType _callback;

    public CoreWebView2WebMessageReceivedEventHandler(
      CoreWebView2WebMessageReceivedEventHandler.CallbackType callback)
    {
