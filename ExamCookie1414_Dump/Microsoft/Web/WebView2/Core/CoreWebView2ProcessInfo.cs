...
// Type: Microsoft.Web.WebView2.Core.CoreWebView2ProcessInfo
...
namespace Microsoft.Web.WebView2.Core
{
  ...
  public class CoreWebView2ProcessInfo
  {
    ...
    internal ICoreWebView2ProcessInfo _nativeICoreWebView2ProcessInfo
    {
      ...
      set => this._nativeICoreWebView2ProcessInfoValue = value;
    }
    ...
    public int ProcessId
    {
      get
      {
        try
        {
          return this._nativeICoreWebView2ProcessInfo.ProcessId;
        }
    ...
    public CoreWebView2ProcessKind Kind
    {
      get
      {
        try
        {
          return (CoreWebView2ProcessKind) this._nativeICoreWebView2ProcessInfo.Kind;
        }
        catch (InvalidCastException ex)
        {
          if (ex.HResult == -2147467262)
