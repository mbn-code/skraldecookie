...
// Type: Microsoft.Web.WebView2.Core.CoreWebView2ContentLoadingEventArgs
...
namespace Microsoft.Web.WebView2.Core
{
  ...
  public class CoreWebView2ContentLoadingEventArgs : EventArgs
  {
    ...
    internal ICoreWebView2ContentLoadingEventArgs _nativeICoreWebView2ContentLoadingEventArgs
    {
      ...
      set => this._nativeICoreWebView2ContentLoadingEventArgsValue = value;
    }
    ...
    public bool IsErrorPage
    {
      get
      {
        try
        {
          return this._nativeICoreWebView2ContentLoadingEventArgs.IsErrorPage != 0;
        }
    ...
    public ulong NavigationId
    {
      get
      {
        try
        {
          return this._nativeICoreWebView2ContentLoadingEventArgs.NavigationId;
        }
        catch (InvalidCastException ex)
        {
          if (ex.HResult == -2147467262)
