...
// Type: Microsoft.Web.WebView2.Core.CoreWebView2ProcessFailedEventHandler
...
namespace Microsoft.Web.WebView2.Core
{
  internal class CoreWebView2ProcessFailedEventHandler : ICoreWebView2ProcessFailedEventHandler
  {
    ...
    public CoreWebView2ProcessFailedEventHandler(
      CoreWebView2ProcessFailedEventHandler.CallbackType callback)
    {
    ...
    {
      this._callback(new CoreWebView2ProcessFailedEventArgs((object) args));
    }
