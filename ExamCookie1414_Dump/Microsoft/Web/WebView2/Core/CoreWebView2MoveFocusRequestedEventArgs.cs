...
// Type: Microsoft.Web.WebView2.Core.CoreWebView2MoveFocusRequestedEventArgs
...
namespace Microsoft.Web.WebView2.Core
{
  ...
  public class CoreWebView2MoveFocusRequestedEventArgs : EventArgs
  {
    ...
    internal ICoreWebView2MoveFocusRequestedEventArgs _nativeICoreWebView2MoveFocusRequestedEventArgs
    {
      ...
      set => this._nativeICoreWebView2MoveFocusRequestedEventArgsValue = value;
    }

    internal CoreWebView2MoveFocusRequestedEventArgs(
      object rawCoreWebView2MoveFocusRequestedEventArgs)
    {
    ...
    public CoreWebView2MoveFocusReason Reason
    {
      get
      {
        try
        {
          return (CoreWebView2MoveFocusReason) this._nativeICoreWebView2MoveFocusRequestedEventArgs.Reason;
        }
    ...
    public bool Handled
    {
      get
      {
        try
        {
          return this._nativeICoreWebView2MoveFocusRequestedEventArgs.Handled != 0;
        }
        catch (InvalidCastException ex)
        {
          if (ex.HResult == -2147467262)
