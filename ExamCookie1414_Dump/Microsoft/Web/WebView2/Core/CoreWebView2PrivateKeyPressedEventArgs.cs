...
// Type: Microsoft.Web.WebView2.Core.CoreWebView2PrivateKeyPressedEventArgs
...
namespace Microsoft.Web.WebView2.Core
{
  internal class CoreWebView2PrivateKeyPressedEventArgs : EventArgs
  {
    ...
    internal ICoreWebView2PrivateKeyPressedEventArgs _nativeICoreWebView2PrivateKeyPressedEventArgs
    {
      ...
      set => this._nativeICoreWebView2PrivateKeyPressedEventArgsValue = value;
    }
    ...
    internal CoreWebView2KeyEventKind KeyEventKind
    {
      get
      {
        try
        {
          return (CoreWebView2KeyEventKind) this._nativeICoreWebView2PrivateKeyPressedEventArgs.KeyEventKind;
        }
    ...
    internal uint VirtualKey
    {
      get
      {
        try
        {
          return this._nativeICoreWebView2PrivateKeyPressedEventArgs.VirtualKey;
        }
        catch (InvalidCastException ex)
        {
          if (ex.HResult == -2147467262)
    ...
    internal int KeyEventLParam
    {
      get
      {
        try
        {
          return this._nativeICoreWebView2PrivateKeyPressedEventArgs.KeyEventLParam;
        }
        catch (InvalidCastException ex)
        {
          if (ex.HResult == -2147467262)
    ...
    internal CoreWebView2PhysicalKeyStatus PhysicalKeyStatus
    {
      get
      {
        try
        {
          return new CoreWebView2PhysicalKeyStatus(this._nativeICoreWebView2PrivateKeyPressedEventArgs.PhysicalKeyStatus);
        }
        catch (InvalidCastException ex)
        {
          if (ex.HResult == -2147467262)
    ...
    internal bool Handled
    {
      get
      {
        try
        {
          return this._nativeICoreWebView2PrivateKeyPressedEventArgs.Handled != 0;
        }
        catch (InvalidCastException ex)
        {
          if (ex.HResult == -2147467262)
