...
// Type: Microsoft.Web.WebView2.Core.CoreWebView2NavigationStartingEventHandler
...
{
  internal class CoreWebView2NavigationStartingEventHandler : 
    ICoreWebView2NavigationStartingEventHandler
  {
    private CoreWebView2NavigationStartingEventHandler.CallbackType _callback;

    public CoreWebView2NavigationStartingEventHandler(
      CoreWebView2NavigationStartingEventHandler.CallbackType callback)
    {
