...
// Type: Microsoft.Web.WebView2.Core.CoreWebView2File
...
namespace Microsoft.Web.WebView2.Core
{
  ...
  public class CoreWebView2File
  {
    ...
    internal ICoreWebView2File _nativeICoreWebView2File
    {
      ...
      set => this._nativeICoreWebView2FileValue = value;
    }

    internal CoreWebView2File(object rawCoreWebView2File) => this._rawNative = rawCoreWebView2File;
    ...
    public string Path
    {
      get
      {
        try
        {
          return this._nativeICoreWebView2File.Path;
        }
