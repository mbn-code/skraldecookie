...
// Type: Microsoft.Web.WebView2.Core.CoreWebView2SourceChangedEventArgs
...
namespace Microsoft.Web.WebView2.Core
{
  ...
  public class CoreWebView2SourceChangedEventArgs : EventArgs
  {
    ...
    internal ICoreWebView2SourceChangedEventArgs _nativeICoreWebView2SourceChangedEventArgs
    {
      ...
      set => this._nativeICoreWebView2SourceChangedEventArgsValue = value;
    }
    ...
    public bool IsNewDocument
    {
      get
      {
        try
        {
          return this._nativeICoreWebView2SourceChangedEventArgs.IsNewDocument != 0;
        }
